...
import { index as templatesIndex, update as templatesUpdate } from '@/routes/admin/templates';
...
export default function AdminTemplatesEdit({ template, errors }: Props) {
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault();
        setProcessing(true);
        router.put(templatesUpdate.url(template.id), {
            title,
            category,
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-3xl p-4">
                ...
                <h1 className="mb-6 text-xl font-bold sm:text-2xl">Edit Template</h1>
